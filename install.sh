...
echo ""
echo "Quick start:"
echo "  export SPONGEBOB_GITHUB_TOKEN=your_token"
echo "  spongebob plan.md"
echo ""
echo "If you use two GitHub accounts, you can add this to your ~/.zshrc or ~/.bashrc:"
echo "  export SPONGEBOB_GITHUB_TOKEN=your_personal_token"
echo "  export SPONGEBOB_GITHUB_WORK_TOKEN=your_work_token"
echo ""
echo "Then use the --work flag for your second account:"
