...
echo ""
echo "Quick start:"
echo "  1. Add your token to ~/.zshrc:"
echo "     echo 'export SPONGEBOB_GITHUB_TOKEN=your_token' >> ~/.zshrc"
echo "     source ~/.zshrc"
echo ""
echo "  2. Open a NEW terminal window (required — tokens are loaded at shell startup)."
echo ""
echo "  3. Run it:"
echo "     spongebob plan.md"
echo ""
echo "If you use two GitHub accounts:"
echo "  echo 'export SPONGEBOB_GITHUB_TOKEN=your_personal_token' >> ~/.zshrc"
echo "  echo 'export SPONGEBOB_GITHUB_WORK_TOKEN=your_work_token' >> ~/.zshrc"
echo "  source ~/.zshrc"
echo "  Then open a new terminal window before using spongebob."
echo ""
echo "Then use the --work flag for your work account:"
echo "  spongebob --work plan.md"
echo ""
